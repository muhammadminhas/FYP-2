...
<div style={{backgroundColor:"#D4D4D4"}}>
        ...
        <div className="col-lg-12 col-mg-12 col-sm-12" id="top2">
          ...
          <button type="button"  className="btn btn-link" style={{color: 'black',float:"right"}}>Profile</button>
          <button type="button" className="btn btn-link" style={{color: 'black',float:"right"}}>Help</button>

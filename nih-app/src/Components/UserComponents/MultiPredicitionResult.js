...
<br />
   ...
   < div className="col-md-12 col-lg-12 col-sm-12 text-center"> 
    <Link to="/multiresult" ><button type="button"  id='viewbtn' className="btn btn-primary btn-md text-center" onClick={convert} style={{ backgroundColor: '#62306A', width: '100px' }}>Submit</button></Link>
    </div>
    <br />
